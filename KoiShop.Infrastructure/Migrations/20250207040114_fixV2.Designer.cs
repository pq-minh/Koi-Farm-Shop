...
namespace KoiShop.Infrastructure.Migrations
{
    ...
    [Migration("20250207040114_fixV2")]
    partial class fixV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoiShop.Domain.Entities.FishCategory", b =>
                {
                    b.Property<int>("FishTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("FishTypeId")
                        .HasName("PK_FishCategory");

                    b.ToTable("FishCategory", (string)null);
                });
            ...
            modelBuilder.Entity("KoiShop.Domain.Entities.BatchKoi", b =>
                {
                    b.HasOne("KoiShop.Domain.Entities.FishCategory", "FishType")
                        .WithMany("BatchKois")
